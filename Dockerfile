...
CMD sh -c '\
  ...
  NODE_OPTIONS="--max-old-space-size=1024" node openclaw.mjs gateway --allow-unconfigured --bind lan --control-ui-dangerously-allow-host-header-origin-fallback true'
